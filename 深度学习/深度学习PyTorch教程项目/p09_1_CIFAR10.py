"""
CIFAR-10 十分类卷积神经网络模型。
教学重点：
1) 三层卷积神经网络架构设计（Conv2d + ReLU + MaxPool2d）
2) Dropout 操作防止过拟合
3) 模型保存与加载（state_dict 方式）
4) 滑动平均损失显示
5) 训练过程中同步测试验证
关于卷积神经网络，最好的电子教材之一：
...
# --- 1. 准备样本 ---
# 1) 样本
ds = datasets.CIFAR10(r'../资源', True, transforms.ToTensor())  # 训练集

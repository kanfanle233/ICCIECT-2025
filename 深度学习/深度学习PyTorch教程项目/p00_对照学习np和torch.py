"""
对照学习 NumPy 与 PyTorch 的基本操作，理解两者在数组/张量层面的异同。
教学重点：Tensor 创建、下标访问、切片、形状变换、维度操作、转置、flatten、unsqueeze、repeat、参数 Parameter。
"""
...
# --- 5. 修改元素值与 nn.Parameter（PyTorch 独有）---

"""
Canny 边缘检测交互式演示 —— 利用滑动条实时调节阈值

教学重点：
1. cv2.createTrackbar 创建滑动条，用于动态调节 Canny 算法的高低阈值
2. cv2.Canny 对灰度图进行边缘检测，低阈值控制弱边缘，高阈值控制强边缘
3. 将边缘检测结果以彩色叠加到原图上，直观展示检测效果
"""

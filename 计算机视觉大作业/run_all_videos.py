...
def run_pipeline(video_path: Path, court_points: str) -> bool:
    ...
    cmd = [
        ...
        "--refine-ball",
        "--ball-top-pad-px", "350",
        "--ball-side-pad-px", "250",
        "--ball-refine-bottom-pad-px", "50",
        "--ball-refine-min-motion-score", "0.0",
        "--ball-refine-max-gap", "15",
        "--ball-max-interp-step-px", "250",
        "--ball-refine-static-run-frames", "15",
        "--ball-refine-static-radius-px", "2.5",
        "--ball-refine-max-dir-change-deg", "175",
        "--ball-refine-sigma-q", "10",
        "--ball-refine-sigma-r", "3",
        "--no-frontend-export",
    ]
